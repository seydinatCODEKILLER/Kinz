                    ...
                    <div class="col-12">
                        <nav>
                            <ul class="d-flex flex-column list-unstyled">
                                <li>
                                    <a href="../../../dashboard.php" class="sidebar-link text-decoration-none text-black d-none d-lg-flex">
                                ...
                                <li class="">
                                    <a href="./residences.php" class="sidebar-link text-decoration-none active text-black d-none d-lg-flex">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-12 bg-white shadow-sm d-flex flex-column justify-content-between" style="min-height: 88vh;">
                                <div class="row d-flex justify-content-between">
                                    ...
                                    <div class="col-3">
                                        <a href="./addResidences.php" class="btn btn-info d-flex align-items-center gap-2 text-white">
                                            ...
                                            <tbody>
                                                <?php if (!empty($residences)) : ?>
                                                    <?php foreach ($residences as $k => $residence) : ?>
                                                        <tr>
                                                            <td>
                                                                <img src="../../uploads/imgResidence/<?= $residence['image'] ?>" alt="image" style="width: 50px;height:50px;" class="rounded">
                                                            </td>
                                                            <td><?= $residence['nom'] ?></td>
                                                            ...
                                                            <td>
                                                                <a href="./formEdits/editResidences.php?id=<?= $residence['ID_Residence'] ?>" class="btn btn-warning btn-sm">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="d-flex gap-3 justify-content-center">
                                                                            <a href="../../controllers/admin/deleteResidence.php?id=<?= $residence['ID_Residence'] ?>"><button class="btn bg-danger text-white">Supprimer</button></a>
