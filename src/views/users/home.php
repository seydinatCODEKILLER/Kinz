                    ...
                    <ul class="splide__list">
                        <li class="splide__slide">
                            <div
                                ...
                                style="
                                            background-image: url(public/images/img-1.png);
                                            background-repeat: no-repeat;
                                            background-size: cover;
                                            background-position: center;
                                            height: 50vh;
                                ">
                                <div class="pop mt-3 rounded d-flex justify-content-center align-items-center text-white position-absolute top-0 end-0">
                                    Le manguier
                                </div>
                            </div>
                        </li>
                        <li class="splide__slide">
                            <div
                                class="rounded position-relative"
                                style="
                                            background-image: url(public/images/img-2.png);
                                            background-repeat: no-repeat;
                                            background-size: cover;
                                            background-position: center;
                                            height: 50vh;
